...
class FBarCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF9F9F4), // Light cream background from image
      body: Center(
      ...
      children: [
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Icon(Icons.horizontal_rule, size: 24, color: Color(0xFF4F4F4F)),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    width: 81,
                    height: 18,
                    padding: const EdgeInsets.symmetric(horizontal: 6), // Added padding for aesthetics
                    decoration: BoxDecoration(
                      color: Colors.white,
        ...
        SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 16), // Gap between text and badge
              // KMS Badge from asset
              Image.asset('asset/icons/kms_badge.png', width: 45, height: 21),
            ],
          ),
        ),
        const SizedBox(height: 12),
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text('IMFL Drinks +FOOD', style: GoogleFonts.lexend(fontWeight: FontWeight.w400)),
          ],
        ),
        const SizedBox(height: 16),
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(colors: [Color(0xFF00E5FF), Color(0xFF96FFAD)]),
          ),
          child: Text(
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Text('Counter Bid', style: GoogleFonts.lexend(fontWeight: FontWeight.bold)),
            )
          ],
        ),
      ],
  ...
  Widget _actionButton(String label, {required bool isPrimary}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: isPrimary ? const LinearGradient(colors: [Color(0xFF7464E4), Color(0xFF1A00D2)]) : null,
        color: isPrimary ? null : Colors.white,
        border: isPrimary ? null : Border.all(color: Colors.grey.shade300),
      ),
      child: Text(label, style: GoogleFonts.lexend(color: isPrimary ? Colors.white : const Color(0xFF7464E4), fontSize: 13, fontWeight: FontWeight.w500)),
    );
  }
}
...
class _BookingDetailsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFF3B28CC), borderRadius: BorderRadius.circular(8)),
      child: Row(
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: const [
        ...
        _FeatureTag(Icons.timer_outlined, '3 Hours'),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(label, style: GoogleFonts.lexend(fontSize: 13, color: Colors.black87)),
        ],
      ),
    );
  }
    ...
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            const Text('Instant Confirmation', style: TextStyle(fontSize: 11, color: Colors.black54)),
            const Text('No Hidden Fees', style: TextStyle(fontSize: 11, color: Colors.black54)),
          ...
          child: Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('MRP ₹2000', style: TextStyle(color: Colors.greenAccent, decoration: TextDecoration.lineThrough, fontSize: 12)),
                  const SizedBox(height: 2),
                  Row(
                    children: [
                      Text('Offer Price ₹1500', style: GoogleFonts.lexend(color: Colors.white, fontWeight: FontWeight.bold)),
                      const SizedBox(width: 8),
                      Text("Kid's Price", style: TextStyle(color: Colors.white, fontSize: 12, decoration: TextDecoration.underline)),
                    ],
                  )
                ],
              ),
              Container(
                ...
                child: const Text('06 : 40 : 59', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              )
            ],
          ),
        )
